...
module.exports = app => {
  ...
  jobFirstTypeRouter.post('/fetch', controller.job.fetchFirstType)
  ...
  jobSecondTypeRouter.post('/fetch', controller.job.fetchSecondType)
  ...
  jobListRouter.post('/fetch', controller.job.fetchJobList)
