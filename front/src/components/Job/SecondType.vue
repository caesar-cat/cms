    ...
    <el-card>
        <el-row>
            <el-table
                ...
                <template slot-scope="scope">
                    <template v-if="scope.row.editable">
                        <el-select v-model="scope.row.first_type" placeholder="请选择一级分类"  @change="handleFiledsChange($event, 'first_type', scope.$index)">
                            <el-option
